import { defineComponent, inject, ref, toRefs, computed, resolveComponent, openBlock, createElementBlock, Fragment, renderList, createBlock, normalizeClass, withCtx, createCommentVNode, toDisplayString } from 'vue';
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { collection: collection2, primaryKey } = toRefs(props);
    const query = computed(() => {
      const fields2 = /* @__PURE__ */ new Set();
      props.links.forEach((link) => {
        var _a;
        getFieldsFromTemplate((_a = link.url) != null ? _a : "").forEach((field) => fields2.add(field));
      });
      return {
        fields: Array.from(fields2)
      };
    });
    const { item } = useItems(collection2, primaryKey, query);
    const { fields } = useCollection(collection2);
    const fullItem = computed(() => {
      var _a, _b, _c;
      const itemValue = (_a = item.value) != null ? _a : {};
      for (const field of fields.value) {
        if ((_c = (_b = field.meta) == null ? void 0 : _b.special) == null ? void 0 : _c.some(
          (special) => RELATIONAL_TYPES.includes(special)
        )) {
          continue;
        }
    ...
    const linksParsed = computed(() => {
      return props.links.map((link) => {
        var _a, _b;
        const parsedLink = lodashExports.omit(link, ["url"]);
        const linkValue = render((_a = link.url) != null ? _a : "", (_b = fullItem.value) != null ? _b : {});
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        (openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList(linksParsed.value, (link, index) => {
            return openBlock(), createBlock(_component_v_button, {
              key: index,
              class: normalizeClass(["action", [link.type]]),
              ...
              default: withCtx(() => [
                link.icon ? (openBlock(), createBlock(_component_v_icon, {
                  key: 0,
                  left: "",
                  name: link.icon
                }, null, 8, ["name"])) : createCommentVNode("v-if", true),
                link.label ? (openBlock(), createElementBlock(
                  "span",
                  _hoisted_2,
              ...
              _: 2
              /* DYNAMIC */
            }, 1032, ["class", "secondary", "icon", "href", "to"]);
          }),
          128
          /* KEYED_FRAGMENT */
        ))
...
var InterfaceBtn2Flow = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-330ce9fe"], ["__file", "interface.vue"]]);
